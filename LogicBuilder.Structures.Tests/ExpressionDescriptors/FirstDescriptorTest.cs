...
{
    public class FirstDescriptorTest
    {
        private static readonly string parameterName = "$it";

        [Fact]
        public void CanSerializeAndDeserialize_FirstDescriptor()
        {
            // Arrange
            var descriptor = new FirstDescriptor
            (
            ...
            var deserializedDescriptor = JsonSerializer.Deserialize<FirstDescriptor>(json, SerializationOptions.Default);
