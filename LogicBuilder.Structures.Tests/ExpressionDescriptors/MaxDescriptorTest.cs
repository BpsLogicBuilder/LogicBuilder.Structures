...
{
    public class MaxDescriptorTest
    {
        private static readonly string parameterName = "$it";

        [Fact]
        public void CanSerializeAndDeserialize_MaxDescriptor()
        {
            // Arrange
            var descriptor = new MaxDescriptor
            (
            ...
            var deserializedDescriptor = JsonSerializer.Deserialize<MaxDescriptor>(json, SerializationOptions.Default);
