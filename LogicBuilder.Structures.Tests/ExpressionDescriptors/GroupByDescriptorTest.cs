...
{
    public class GroupByDescriptorTest
    {
        private static readonly string parameterName = "$it";

        [Fact]
        public void CanSerializeAndDeserialize_GroupByDescriptor()
        {
            // Arrange
            ...
            var deserializedDescriptor = JsonSerializer.Deserialize<GroupByDescriptor>(json, SerializationOptions.Default);
